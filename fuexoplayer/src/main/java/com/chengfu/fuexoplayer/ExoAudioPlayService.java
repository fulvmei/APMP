...
public class ExoAudioPlayService extends Service implements IAudioPlay {
    ...
    protected void updataNotifitionData(RemoteViews remoteViews) {
        ...
        remoteViews.setTextViewText(R.id.media_tvInfo, "");
        if (isPlaying()) {
            remoteViews.setImageViewResource(R.id.media_imgBtnPlayPause, R.drawable.ic_default_pause);
        } else {
            remoteViews.setImageViewResource(R.id.media_imgBtnPlayPause, R.drawable.ic_default_play);
        }
    }
