...
public class MatrixManager {
    ...
    @NonNull
    protected ExoVideoView.ScaleType currentScaleType = ExoVideoView.ScaleType.FIT_CENTER;

    @Nullable
    protected Integer requestedRotation = null;
    @Nullable
    protected ExoVideoView.ScaleType requestedScaleType = null;
    @NonNull
    ...
    @NonNull
    public ExoVideoView.ScaleType getCurrentScaleType() {
     ...
     */
    public boolean scale(@NonNull View view, @NonNull ExoVideoView.ScaleType scaleType) {
        if (!ready()) {
    ...
    /**
     * Applies the {@link ExoVideoView.ScaleType#CENTER} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link ExoVideoView.ScaleType#CENTER_CROP} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link ExoVideoView.ScaleType#CENTER_INSIDE} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link ExoVideoView.ScaleType#FIT_CENTER} to the specified matrix.  This will
