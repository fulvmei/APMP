...
/**
 * A standard entry point for registering additional {@link Renderer}s and
...
public class ExoMedia {
    ...
    /**
     * Registers additional customized {@link Renderer}s
    ...
    /**
     * Specifies the provider to use when building {@link HttpDataSource.BaseFactory}
     * instances for use with the {@link com.chengfu.fuexoplayer.code.source.builder.MediaSourceBuilder}s. This will
     * only be used for builders that haven't customized the {@link com.chengfu.fuexoplayer.code.source.builder.MediaSourceBuilder#buildDataSourceFactory(Context, String, TransferListener)}
     * method.
     *
     * @param provider The provider to use for the {@link com.chengfu.fuexoplayer.code.source.builder.MediaSourceBuilder}s
     */
     ...
     * used in the {@link com.chengfu.fuexoplayer.widget.ExoVideoView}
